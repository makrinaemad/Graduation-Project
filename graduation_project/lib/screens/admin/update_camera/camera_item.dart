...
class CameraItem extends StatelessWidget {
  ...
  Camera camera ;
  RoadModel road;
  CameraItem (this.camera,this.road,{super.key});
        ...
        startActionPane: ActionPane(motion: DrawerMotion(),
          children: [
            ...
            SlidableAction(onPressed: (BuildContext cotext){
              ...
              Navigator.push(context, MaterialPageRoute(builder: (context) => EditBottomSheet()));
            //  BottomSheet
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                     ...
                     // SizedBox(width: 5,),
                      Text("Location : ${road.id}",style: TextStyle(fontSize: 20,
                        fontWeight: FontWeight.w500,
                        color:Colors.white,)),
