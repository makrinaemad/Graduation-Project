...
import 'gradient_divider.dart'; // Import the intl package for time formatting
...
class _TimePickerTextFieldState extends State<TimePickerTextField> {
  ...
  Future<void> _selectTime(BuildContext context) async {
    ...
    if (pickedTime != null) {
      ...
      context.read<ForecastCubit>().time= _selectedDateTime;
      print(context.read<ForecastCubit>().time);
  ...
  Widget build(BuildContext context) {
    ...
    String formattedTime = _selectedDateTime != null
        ? DateFormat('HH:mm:ss').format(_selectedDateTime!)
        : '';
